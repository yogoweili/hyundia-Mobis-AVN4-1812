...
extern void get_emmc_splash_img(char *partition);
extern int get_splash_img_name(char *name);
#endif

#ifdef CRC_CHECK_EMMC
extern unsigned long long emmc_get_capacity(void);
#endif
