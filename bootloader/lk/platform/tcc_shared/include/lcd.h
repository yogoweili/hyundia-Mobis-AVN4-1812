...
#define __LCD_H__
	...
	#if defined(CLAA104XA01CW) || defined(HT121WX2) || defined(N101L6) || defined(CLAA102NA0DCW) || defined(ED090NA) || defined(CLAA070NP01)|| defined(HV070WSA) || defined(FLD0800) || defined(CLAA070WP03) || defined(EJ070NA) || defined(DAUDIOLCD)	//! DAUDIOLCD define added for LVDS by daudio@cleinsoft
