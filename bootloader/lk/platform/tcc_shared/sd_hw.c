...
* @date 2014/11/25
* sd card port mapping for daudio
**/
	...
	/* 0x1000 : TCC8930_D3_08X4_SV0.1 - DDR3 1024(32Bit) */	
			gpio_config(TCC_GPD(29) , GPIO_FN2|GPIO_CD3);	// SD3_D0
			gpio_config(TCC_GPD(28) , GPIO_FN2|GPIO_CD3);	// SD3_D1
			gpio_config(TCC_GPD(27) , GPIO_FN2|GPIO_CD3);	// SD3_D2
			gpio_config(TCC_GPD(26) , GPIO_FN2|GPIO_CD3);	// SD3_D3
			gpio_config(TCC_GPD(25) , GPIO_FN2|GPIO_CD3);	// SD3_D4
			gpio_config(TCC_GPD(24) , GPIO_FN2|GPIO_CD3);	// SD3_D5
			gpio_config(TCC_GPD(23) , GPIO_FN2|GPIO_CD3);	// SD3_D6
			gpio_config(TCC_GPD(22) , GPIO_FN2|GPIO_CD3);	// SD3_D7
			gpio_config(TCC_GPD(30) , GPIO_FN2|GPIO_CD3);	// SD3_CMD
			gpio_config(TCC_GPD(31) , GPIO_FN2|GPIO_CD3);	// SD3_CLK
		#endif
	#endif
