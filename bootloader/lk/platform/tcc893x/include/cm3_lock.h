...
typedef struct {
	...
	volatile unsigned int decoder_chip; // tw8836 -> 8836 , tw9912 -> 9912
	volatile unsigned int camera_type; // common -> 0X100, pgs -> 0x200, avm_svideo -> 0X300, avm_component -> 0X400  //GT system IM002A-368
...
int cm3_set_camera_type(unsigned int type); //GT system IM002A-368
