 ...
 ******************************************************************************/
typedef int (*tDeviceRwFunctions)(int, unsigned long, unsigned long, void *);

typedef int (*tDeviceWriteMultiStartFunctions)(unsigned long, unsigned long);
typedef int (*tDeviceWriteMultiFunctions)(int, unsigned long, unsigned long, void *);
typedef int (*tDeviceWriteMultiStopFunctions)(void);

typedef int (*tDeviceReadMultiStartFunctions)(unsigned long, unsigned long);
typedef int (*tDeviceReadMultiFunctions)(int, unsigned long, unsigned long, void *);
typedef int (*tDeviceReadMultiStopFunctions)(void);

typedef unsigned long (*tDeviceHiddenRWFunctions)(unsigned long , unsigned long, unsigned char *);
...
int		DISK_WriteSector(int drv_type, int lun, unsigned long lba_addr, unsigned long nSector, void *buff);
