...
#define UMP_RESERVED_SIZE		(27*SZ_1M)//40 for 720p

#ifdef CONFIG_V4L2_VIDEO_INPUT_DRIVER
#define V4L2_VIDEO0_SIZE        (24 * SZ_1M)
#define V4L2_VIDEO1_SIZE        (0 * SZ_1M)
#define V4L2_VIDEO2_SIZE        (0 * SZ_1M)
#define V4L2_VIDEO3_SIZE        (0 * SZ_1M)
#define V4L2_VIDEO4_SIZE        (0 * SZ_1M)
#else
#define V4L2_VIDEO0_SIZE        (0 * SZ_1M)
#define V4L2_VIDEO1_SIZE        (0 * SZ_1M)
#define V4L2_VIDEO2_SIZE        (0 * SZ_1M)
#define V4L2_VIDEO3_SIZE        (0 * SZ_1M)
#define V4L2_VIDEO4_SIZE        (0 * SZ_1M)
...
#ifdef SUPPORT_VIOC_SCALER_FOR_DFB
#define DIRECTFB_HW_MEM_SIZE	(8 * SZ_1M)
#else
#define DIRECTFB_HW_MEM_SIZE	(0)
#endif

#define TOTAL_FIXED_MEM_SIZE		(PMEM_SURF_SIZE + PMEM_VIQE_SIZE+ UMP_RESERVED_SIZE + V4L2_VIDEO_TOTAL_SIZE + EXT_CAM_SIZE  + FB_MEM_SIZE + OVERLAY_MEM_TOTAL_SIZE + VIDEO_MEM_TOTAL_SIZE + FB_SCALE_MEM_TOTAL_SIZE + VIDEO_DUAL_DISPLAY_SIZE + FB_WMIXER_MEM_SIZE + RAM_CONSOLE_SIZE + JPEG_ENC_CAPTURE_SIZE + JPEG_RAW_CAPTURE_SIZE + NAND_MEM_SIZE+VIDEO_MEM_EXT_SIZE+SECURED_IN_MEM_SIZE+VIDEO_SBACKUP_MEM_SIZE+VIDEO_THUMB_MEM_SIZE+DIRECTFB_HW_MEM_SIZE)
...
#endif
#define UMP_RESERVED_BASE		(PMEM_SURF_BASE + PMEM_SURF_SIZE)
...
#define FB_WMIXER_MEM_BASE		(V4L2_VIDEO4_BASE + V4L2_VIDEO4_SIZE)
#define RAM_CONSOLE_BASE		(FB_WMIXER_MEM_BASE + FB_WMIXER_MEM_SIZE)
#define SECURED_IN_MEM_BASE		(RAM_CONSOLE_BASE + RAM_CONSOLE_SIZE )
...
#define PMEM_VIQE_BASE			(VIDEO_THUMB_MEM_BASE + VIDEO_THUMB_MEM_SIZE)
...
#define JPEG_ENC_CAPTURE_BASE	(NAND_MEM_BASE + NAND_MEM_SIZE)
...
#define DIRECTFB_HW_MEM_BASE	(VIDEO_MEM_EXT_BASE + VIDEO_MEM_EXT_SIZE)
