...
extern void * memset(void * s, int c, unsigned long count);
#endif
...
// 
///////////////////////////////////////////////////////////////////////////////////
void * FWUG_GetTempBuffer(unsigned int uiBufSize)
{
#if defined(NKUSE) || defined(__KERNEL__)
	static unsigned long ulTempBuffer[16*1024];
	if(uiBufSize<=16*1024)
		return (void*)ulTempBuffer;
	else
		return NULL;
#else
...
/**************************************************************************
*  FUNCTION NAME : 
*      unsigned int		FWUG_GetMemInitCodeSizeInByte
*  
*  DESCRIPTION : 
*  INPUT:
*  
...
*  REMARK  :	
**************************************************************************/
#if !defined(__KERNEL__) && !defined(NKUSE)
...
extern unsigned long InitRoutine_StartBase;
	...
	return (unsigned int)(InitRoutine_StartLimit - InitRoutine_StartBase);
}
#endif
...
{
	unsigned int	iRev;	
	unsigned int   	uiBufSize = 16*1024;
	unsigned char 	*buf;	
