...
#define OVERLAY_ROTATION_MEM_SIZE                      (6 * SZ_1M)
#else
...
#define OVERLAY_MEM_BASE		(SECURED_IN_MEM_BASE + SECURED_IN_MEM_SIZE)
#define VIDEO_MEM_BASE			(OVERLAY_MEM_BASE + OVERLAY_MEM_TOTAL_SIZE)
#define PMEM_VIQE_BASE			(VIDEO_MEM_BASE + VIDEO_MEM_TOTAL_SIZE)
