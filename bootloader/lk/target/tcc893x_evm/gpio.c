...
struct gpio_cfg TCC8930_GPA_init_tbl[] = {
	...
	{ TCC_GPA(21) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
#if (HW_REV == 0x1000)
...
struct gpio_cfg TCC8930_GPB_init_tbl[] = {
	...
	{ TCC_GPB(31) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
};
...
struct gpio_cfg TCC8930_GPF_init_tbl[] = {
	...
	{ TCC_GPF(29) ,GPIO_FN0 , GPIO_INPUT , GPIO_PULLDOWN },
#else
