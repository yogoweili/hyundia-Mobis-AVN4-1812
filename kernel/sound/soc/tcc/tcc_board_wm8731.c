...
static int tcc_wm8524_dummy_init(struct snd_soc_pcm_runtime *rtd)
{
	alsa_dbg("%s() \n", __func__);
    return 0;
}
...
// *** TCC Audio Device registration-sequence ***
// *** pcmC0D0c: Audio0 I2S Capture           ***
// *** pcmC0D0p: Audio0 I2S Player            ***
// *** pcmC0D1c: Audio0 SPDIF Capture         ***
// *** pcmC0D1p: Audio0 SPDIF player          ***
// *** pcmC0D2C: Audio1 I2S Capture           ***
// *** pcmC0D2p: Audio1 I2S Player            ***
// *** pcmC0D3c: Audio1 SPDIF Capture         ***
// *** pcmC0D3p: Audio1 SPDIF Player          ***
