/*
*  drivers/input/touchscreen/atmel_mxt1540E_cfg.h
*
...
*
*/
#ifndef __ATMEL_MXT540E_CFG_H
#define __ATMEL_MXT540E_CFG_H
...
#if 0
/* FIXME : mXT540E does not support T23 */
typedef struct {
	/** Prox Configuration **/
	/*  ACENABLE LCENABLE Main configuration field           */
	uint8_t ctrl;
...
typedef struct {
	...
	uint8_t reserved0;// = T62_RESERVED0;
