...
static int ehci_tcc_drv_probe(struct platform_device *pdev)
{
	...
	#if defined(CONFIG_STB_BOARD_UPC) || defined(CONFIG_STB_BOARD_UPC_TCC893X) || defined(CONFIG_STB_BOARD_YJ8930T) || defined(CONFIG_STB_BOARD_YJ8933T)
	{
