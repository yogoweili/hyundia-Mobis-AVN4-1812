...
USBPHY_MODE_T USBPHY_SetMode(dwc_otg_core_if_t *_core_if, USBPHY_MODE_T mode)
{
	...
	switch (sUSBPHY_Mode) {
		...
		case USBPHY_MODE_RESET:
		{
         ...
         pUSBPHYCFG->UPCR0 = 0x4870 | UPCR0_RCD_24;
#else
		...
		{
#if defined(CONFIG_CHIP_TCC8935S)
         pUSBPHYCFG->UPCR0 = 0x2800 | UPCR0_RCD_24;
#else
...
#if defined(CONFIG_CHIP_TCC8935S)
         pUSBPHYCFG->UPCR0 = 0x4840 | UPCR0_RCD_24;
         pUSBPHYCFG->UPCR0 = 0x6940 | UPCR0_RCD_24;
#else
...
{
	if (power)
#if defined(CONFIG_ARCH_TCC88XX) || defined(CONFIG_ARCH_TCC93XX) || defined(CONFIG_ARCH_TCC892X) || defined(CONFIG_CHIP_TCC8935S)
...
#endif
	{
	#if defined(CONFIG_ARCH_TCC892X) || defined(CONFIG_CHIP_TCC8935S)
