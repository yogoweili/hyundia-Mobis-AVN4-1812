...
//ADDED_CODE_FOR_MOBIS_DEVICE(+)
char mac_address_read[100];  
//ADDED_CODE_FOR_MOBIS_DEVICE(-)
...
//=============================================================
module_param_string(mac_address_read, mac_address_read, 100, 0644);
//module_param_string(mac_address_read, mac_address_read, 100, 0660);
//=============================================================
/* Watchdog interval */
...
//ADDED_CODE_FOR_MOBIS_DEVICE(+)
int fw_path_change(void) 
{
	struct file *fp=NULL;
	char buf[100]={0x00,};
	int len =0;
	fp = filp_open("/data/misc/wifi/firmware_path", O_RDWR, 0);
	...
	len=kernel_read(fp, 0, buf, 99);

	printk("path_change %s \n",buf);
...
dhd_preinit_ioctls(dhd_pub_t *dhd)
{
	...
	//=============================================================  
	//FEATURE_MOBIS_WIFI
	//jaehyungkim@mobis.co.kr 2014.05.22
	//increase bcn_timeout to fix iphone disconnect issue
	//=============================================================
	uint bcn_timeout = 5;
	//uint bcn_timeout = 4;
	//=============================================================	
    ...
    //jaehyungkim@mobis.co.kr 2014.12.19
    //=============================================================
	sprintf(mac_address_read, "%02x:%02x:%02x:%02x:%02x:%02x", MAC2STRDBG(dhd->mac.octet)); //hyuki
    //=============================================================
	...
	//=============================================================  
	//FEATURE_MOBIS_WIFI
	//jaehyungkim@mobis.co.kr 2015.01.06
	//disable txglom
	//=============================================================
