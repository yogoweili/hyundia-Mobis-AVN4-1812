...
static int tcc_component_detect_cable(void)
{
	int ret = true;
		...
		#elif defined(CONFIG_TCC_OUTPUT_AUTO_HDMI_CVBS)
			ret = false;
		#endif
	#endif
...
#if defined(CONFIG_ARCH_TCC893X)
void tcc_output_starter_memclr(unsigned char lcdc_num, unsigned char output_type, int img_width, int img_height)
{
...
void tcc_output_starter_hdmi(unsigned char lcdc_num, unsigned char hdmi_resolution)
{
	...
	tcc_output_starter_memclr(lcdc_num, STARTER_OUTPUT_HDMI, image_width, image_height);
...
void tcc_output_starter_composite(unsigned char lcdc_num, unsigned char type)
{
	...
	tcc_output_starter_memclr(lcdc_num, STARTER_OUTPUT_COMPOSITE, image_width, image_height);
...
void tcc_output_starter_component(unsigned char lcdc_num, unsigned char type)
{
	...
	tcc_output_starter_memclr(lcdc_num, STARTER_OUTPUT_COMPONENT, image_width, image_height);
