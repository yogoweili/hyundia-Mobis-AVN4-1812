...
#ifndef _ATMEL_MXT540E_H
#define _ATMEL_MXT540E_H
...
/* For Charger */
/* i remove this option by #if 0 because of too many options */
...
//D-Audio settings.
#define MAXTOUCH_FAMILYID				0x82
#define MXT540_FIRM_VER1_VARIANTID		0x20
#define MXT540_FIRM_VER2_VARIANTID		0x20
#else
#define MAXTOUCH_FAMILYID		0xA1
#define MXT540_FIRM_VER1_VARIANTID		0x0C
#define MXT540_FIRM_VER2_VARIANTID		0x0C
#endif
...
#define MXT_TOUCH_PROXIMITY_T23                         23u	//valky ?
...
#define MXT_HID_CONFIG_T43				43u					//valky ?
#define MXT_MESSAGECOUNT_T44				44u
#define MXT_SPT_CTECONFIG_T46                           46u
#define MXT_PROCI_STYLUS_T47                            47u
#define MXT_PROCG_NOISESUPPRESSION_T48                  48u	//valky ?
//valky #define MXT_PROCG_NOISESUPPRESSION_T48                  62u	//valky ?
#define MXT_PROCG_NOISESUPPRESSION_T62                  62u	//valky ?
#define MXT_TOUCH_PROXIMITY_T52                         52u	//valky ?
#define MXT_DATA_SOURCE_T53				53u					//valky ?
...
#else
#define	MXT_MAX_OBJECT_TYPES_VER2			58u
#endif
...
/* Firmware */
#define MXT540E_FIRMWARE "mxt540e.fw"
