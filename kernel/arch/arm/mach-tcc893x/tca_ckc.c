...
{
    unsigned uCnt, div_num, div_value, pll_ch;
    sfPLL    *pPLL;
    volatile PLLCFG_TYPE *pPLLCFG = (PLLCFG_TYPE *)((&pCKC->PLL0CFG)+CPU_SRC_CH);

    // 1. temporally change the cpu clock source.(XIN)
#if (1)
#if (1)  /* use other pll source */
    div_num = freq/(stMinPLLRate/16);
    switch (div_num) {
        case 0:
        case 1: div_value = 0x1000; break;
        case 2: div_value = 0x1010; break;
        case 3: div_value = 0x1110; break;
        case 4: div_value = 0x1111; break;
        case 5: div_value = 0x5111; break;
        case 6: div_value = 0x5151; break;
        case 7: div_value = 0x5551; break;
        case 8: div_value = 0x5555; break;
        case 9: div_value = 0x7555; break;
        case 10: div_value = 0x7575; break;
        case 11: div_value = 0x7775; break;
        case 12: div_value = 0x7777; break;
        case 13: div_value = 0xF777; break;
        case 14: div_value = 0xF7F7; break;
        case 15: div_value = 0xFFF7; break;
        default: div_value = 0xFFFF; break;
    }
    switch(stMinPLLCh) {
        case 0:
        case 1:
    ...
    pCKC->CLKCTRL0.bREG.SEL = pll_ch;
    while(pCKC->CLKCTRL0.bREG.CHGREQ);
    pCKC->CLKCTRL0.bREG.CONFIG = div_value&0xFFFF;
