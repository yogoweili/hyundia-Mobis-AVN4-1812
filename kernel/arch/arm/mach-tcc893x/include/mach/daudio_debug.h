...
#define TAG_DAUDIO_PINCTL			"[cleinsoft gpio_pinctl] "

#define DEBUG_DAUDIO_LVDS			1
#define TAG_DAUDIO_LVDS				"[cleinsoft lvds] "

#define DEBUG_DAUDIO_ATV	0	
#define TAG_DAUDIO_ATV				"[cleinsoft daudio_atv] "
#define TAG_DAUDIO_TW9912			"[cleinsoft tw9912] "
#define TAG_DAUDIO_TW8836			"[cleinsoft tw8836] "

#define DEBUG_DAUDIO_CMMB			1
#define TAG_DAUDIO_CMMB				"[cleinsoft cmmb] "
...
#define CLOG_TAG_CLEINSOFT		"cleinsoft"
