...
#define PHY_INFSEL_ONLY_MODE //PHY_INFSEL Only Mode
...
#if defined(CONFIG_DAUDIO) && (CONFIG_DAUDIO_BSP_VERSION >= 20140220)
	...
	#define GPIO_PHY_RST		TCC_GPC(16)
	#define INT_PHY_IRQ			TCC_GPC(26)
#else
	// GMAC
...
static void tca_gmac_clk_enable(void)
{
	...
	if (gmac_clk)
	{
		...
		printk(KERN_INFO "%s RMII MODE 50MHz\n", __func__);
...
static void tca_gmac_portinit(void)
{
	...
	#define GMAC_DRV_STRENGTH_1		1
	#define GMAC_DRV_STRENGTH_2		2
	#define GMAC_DRV_STRENGTH_3		3

		tcc_gpio_config(GPIO_GMAC_TXD0, GPIO_FN(1) | GPIO_CD(GMAC_DRV_STRENGTH_2));
		tcc_gpio_config(GPIO_GMAC_TXD1, GPIO_FN(1) | GPIO_CD(GMAC_DRV_STRENGTH_2));
		tcc_gpio_config(GPIO_GMAC_TXEN, GPIO_FN(1) | GPIO_CD(GMAC_DRV_STRENGTH_2));
		tcc_gpio_config(GPIO_GMAC_TXCLK, GPIO_FN(1)
				| GPIO_CD(GMAC_DRV_STRENGTH_3 | GPIO_PULLDOWN));
		tcc_gpio_config(GPIO_GMAC_RXD0, GPIO_FN(1) | GPIO_CD(GMAC_DRV_STRENGTH_2));
		tcc_gpio_config(GPIO_GMAC_RXD1, GPIO_FN(1) | GPIO_CD(GMAC_DRV_STRENGTH_2));
		tcc_gpio_config(GPIO_GMAC_RXER, GPIO_FN(1) | GPIO_CD(GMAC_DRV_STRENGTH_2));
		tcc_gpio_config(GPIO_GMAC_RXDV, GPIO_FN(1) | GPIO_CD(GMAC_DRV_STRENGTH_2));
		tcc_gpio_config(GPIO_GMAC_MDC, GPIO_FN(1) | GPIO_CD(GMAC_DRV_STRENGTH_2));
		tcc_gpio_config(GPIO_GMAC_MDIO, GPIO_FN(1) | GPIO_CD(GMAC_DRV_STRENGTH_2));
#elif 0
...
#if defined(CONFIG_DAUDIO)
		pGPIO->GPCSR.bREG.GP00 = 0;
		pGPIO->GPCSR.bREG.GP01 = 0;
		pGPIO->GPCSR.bREG.GP02 = 0;
		pGPIO->GPCSR.bREG.GP03 = 0;
		pGPIO->GPCSR.bREG.GP04 = 0;
		pGPIO->GPCSR.bREG.GP05 = 0;
		pGPIO->GPCSR.bREG.GP06 = 0;
		pGPIO->GPCSR.bREG.GP07 = 0;
		pGPIO->GPCSR.bREG.GP08 = 0;
		pGPIO->GPCSR.bREG.GP14 = 0;
#elif 1
