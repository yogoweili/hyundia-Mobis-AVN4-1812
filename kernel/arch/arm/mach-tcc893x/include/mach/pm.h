...
#define MISC_PARTITION_PATH "/dev/block/mmcblk0p8"
...
#define SDRAM_INIT_FUNC_SIZE     0x00000E00

#define GPIO_REPOSITORY_ADDR     0xF0002000
#define GPIO_REPOSITORY_SIZE     0x00000300

#define CPU_DATA_REPOSITORY_ADDR 0xF0002300
#define CPU_DATA_REPOSITORY_SIZE 0x00000100

#if defined(MEMBUS_CLK_AUTO_RESTORE)
#define SDRAM_INIT_PARAM_ADDR    0xF0002400
#define SDRAM_INIT_PARAM_APHY    0x00002400
#define SDRAM_INIT_PARAM_SIZE    0x00000010

#define SDRAM_TIME2CYCLE_ADDR    0xF0002410
#define SDRAM_TIME2CYCLE_APHY    0x00002410
...
#define SLEEP_FUNC_SIZE          0x00001000
