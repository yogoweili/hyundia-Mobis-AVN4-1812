...
#endif
#ifdef CONFIG_LCD_LB070WV7
static struct platform_device lb070wv7_lcd = {
	.name   = "lb070wv7_lcd",
	.dev    = {
		.platform_data  = &lcd_pdata,
	},
 ...
 * @date 2013/07/19
 * daudio_lvds platform device register
 * @date 2014/09/12
 * daudio_lvds platform device already registered.
 * @see kernel/drivers/video/tcc/lcd_DAUDIOLCD.c
 **/
#ifdef CONFIG_LCD_DAUDIOLCD
	case PANEL_ID_DAUDIOLCD:
		//Already register platform device
		break;
#endif
#ifdef CONFIG_LCD_LB070WV7
	case PANEL_ID_LB070WV7:
		platform_device_register(&lb070wv7_lcd);
		break;
#endif
