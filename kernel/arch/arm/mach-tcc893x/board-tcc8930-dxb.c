...
// TDMB only <CH:0>
#define GPIO_DXB0_SDO				TCC_GPC(22)
#define GPIO_DXB0_SDI               TCC_GPC(23)
#define GPIO_DXB0_SFRM              TCC_GPC(24)
#define GPIO_DXB0_SCLK   			TCC_GPC(25)
#define GPIO_DXB0_RST				TCC_GPF(3)
#define INT_DXB0_IRQ				TCC_GPA(1) 
...
#define GPIO_DXB1_RST				TCC_GPF(5)
#define INT_DXB1_IRQ				TCC_GPA(1)
...
static unsigned int guiBoardType = BOARD_DXB_TCC3171;
	...
	if(machine_is_tcc893x())
	{
		...
		if(guiBoardType == BOARD_DXB_TCC3171)
		{
			...
			case 0:			
                ...
                // DMB_ANT_SHDN
   	            tcc_gpio_config(TCC_GPF(8), GPIO_FN0|GPIO_OUTPUT|GPIO_HIGH);
   	            printk("[tcc_dxb_ctrl_power_pure_on] TCC_GPF(8) : Set DMB_ANT_SHDN to UP(1)\n");
